...
if __name__ == "__main__":
    ...
    print ('loading laws and accus.')
    train_laws = np.load(os.path.join(data_path, "generated/new_bigdata_train_cuted_law.npy"))
    train_accus = np.load(os.path.join(data_path, "generated/new_bigdata_train_cuted_accu.npy"))
    
    test_laws = np.load(os.path.join(data_path, "generated/new_bigdata_test_cuted_law.npy"))
    test_accus = np.load(os.path.join(data_path, "generated/new_bigdata_test_cuted_accu.npy"))
    
    print ('loading facts and terms.')
    ...
    train_pair_front_word = np.load(os.path.join(data_path, "generated/new_bigdata_train_pair_front_id.npy"))
    train_pair_last_word = np.load(os.path.join(data_path, "generated/new_bigdata_train_pair_last_id.npy"))
    train_pair_front_isword = np.load(os.path.join(data_path, "generated/new_bigdata_train_pair_front_word.npy"))
    train_pair_last_isword = np.load(os.path.join(data_path, "generated/new_bigdata_train_pair_last_word.npy"))

    train_pair_front_num = np.load(os.path.join(data_path, "generated/new_bigdata_train_pair_front_num.npy"))
    train_pair_last_num = np.load(os.path.join(data_path, "generated/new_bigdata_train_pair_last_num.npy"))
    train_pair_front_isnum = np.load(os.path.join(data_path, "generated/new_bigdata_train_pair_front_dig.npy"))
    train_pair_last_isnum = np.load(os.path.join(data_path, "generated/new_bigdata_train_pair_last_dig.npy"))




    test_pair_front_word = np.load(os.path.join(data_path, "generated/new_bigdata_test_pair_front_id.npy"))
    test_pair_last_word = np.load(os.path.join(data_path, "generated/new_bigdata_test_pair_last_id.npy"))
    test_pair_front_isword = np.load(os.path.join(data_path, "generated/new_bigdata_test_pair_front_word.npy"))
    test_pair_last_isword = np.load(os.path.join(data_path, "generated/new_bigdata_test_pair_last_word.npy"))

    test_pair_front_num = np.load(os.path.join(data_path, "generated/new_bigdata_test_pair_front_num.npy"))
    test_pair_last_num = np.load(os.path.join(data_path, "generated/new_bigdata_test_pair_last_num.npy"))
    test_pair_front_isnum = np.load(os.path.join(data_path, "generated/new_bigdata_test_pair_front_dig.npy"))
    test_pair_last_isnum = np.load(os.path.join(data_path, "generated/new_bigdata_test_pair_last_dig.npy"))
    ...
    totaltrain = 1588894
    totaltest = 185228
    train_accu_list = [list(range(0, config.num_accu_liu))] * totaltrain
    train_law_list = [list(range(0, config.num_law_liu))] * totaltrain
    train_term_list = [list(range(0, config.num_term_liu))] * totaltrain
    ...
    print train_singlefacts.shape

    test_accu_list = [list(range(0, config.num_accu_liu))] * totaltest
    test_law_list = [list(range(0, config.num_law_liu))] * totaltest
    test_term_list = [list(range(0, config.num_term_liu))] * totaltest
