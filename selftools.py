...
def load_data(file_name):
    facts = np.load(os.path.join(data_path, "generated/" + file_name + "_fact.npy")) #train:(115472,64,64);test:(26766,64,64)
    laws = np.load(os.path.join(data_path, "generated/" + file_name + "_law.npy")) #train:(115472,);test:(26766,)
    accus = np.load(os.path.join(data_path, "generated/" + file_name + "_accu.npy"))#train:(115472,);test:(26766,)

    return facts, laws, accus
