...
if __name__ == '__main__':
    ...
    useful = [2,3,7,8,11,12,13,16,18,22,23,24,25]#rel:nmod:tmod;dep;advmod:loc;mark:clf;
                                                 #nmod;ccome;nmod:range;parataxis:prnmod;
                                                 #nmod:topic;xcomp;advcl:loc;advmod:dvp;det;
